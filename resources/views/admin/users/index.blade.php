   ...
   <div class="card mb-4">
    ...
    <script>
        ...
        viewUserModal.addEventListener('show.bs.modal', async (event) => {
            ...
            modalBody.innerHTML = `<div class="p-2"><h6 class="mt-4">Personal Info</h6><div class="row"><div class="col-md-6"><p><small class="text-muted">Email</small><br>${user.email}</p></div><div class="col-md-6"><p><small class="text-muted">Phone</small><br>${user.phone_number || 'N/A'}</p></div><div class="col-md-6"><p><small class="text-muted">Gender</small><br>${user.gender ? user.gender.charAt(0).toUpperCase() + user.gender.slice(1) : 'N/A'}</p></div><div class="col-md-6"><p><small class="text-muted">DOB</small><br>${user.date_of_birth || 'N/A'}</p></div><div class="col-12"><p><small class="text-muted">Address</small><br>${user.address || 'N/A'}</p></div></div>${professionalDetails}${appointmentStats}</div>`;
        });
